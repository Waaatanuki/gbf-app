        ...
        <el-card class="box-card">
            ...
            <div class="result" style="margin-top:10px">
                <el-descriptions title="结果" border :column="2">
                    <el-descriptions-item label="总贡献" align="center">{{ totalHonor + ' 亿' }}</el-descriptions-item>
                    <el-descriptions-item label="所需肉量" align="center"> {{ totalMeat }} </el-descriptions-item>
                    <el-descriptions-item :label="opt.title" :span="2" align="center"
...
const formatTooltip = (value) => (value / 10 + '亿贡献')
