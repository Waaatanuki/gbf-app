      ...
      <el-form :model="form" label-width="80px">
        <el-form-item label="加护: ">
          <el-radio-group v-model="form.main">
            <el-radio :label="300">双面神石</el-radio>
            <el-radio :label="150">单面神石</el-radio>
            <el-radio :label="280">双面方阵</el-radio>
            <el-radio :label="140">单面方阵</el-radio>
            <el-radio :label="0">无加护</el-radio>
          </el-radio-group>
        </el-form-item>
