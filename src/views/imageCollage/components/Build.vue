<template>
  ...
  >
    ...
    >
      ...
      <div v-else>{{ uploaderConfig[0].label }}</div>
    </div>
    <div
      :style="{
    ...
    >
      ...
      >
        ...
        />
        <div v-else>{{ uploaderConfig[1].label }}</div>
      </div>
      <div
        :style="{
          width: uploaderConfig[1].cropWidth + 'px',
      ...
      >
        ...
        >
          ...
          />
          <div v-else>{{ uploaderConfig[2].label }}</div>
        </div>
        <div
          :style="{
        ...
        >
          ...
          />
          <div v-else>{{ uploaderConfig[3].label }}</div>
        </div>
      </div>
    </div>
  </div>
  ...
  >
    ...
    >
      <template v-for="item in uploaderConfig">
        <el-form-item
      ...
      <el-form-item>
        <el-button @click="uploaderConfig = defaultUploader" type="primary"
          >重置</el-button
        >
      </el-form-item>
    </el-form>
