<template>
    <el-button type="danger" :disabled="typeof analyser == 'object'" @click="init">帕拉戴斯罗斯特</el-button>
    <canvas ref="canvas" :width="WIDTH" :height="HEIGHT"></canvas>
    <audio ref='audio1' controls></audio>
    <el-upload ref="upload" :limit="1" :on-exceed="handleExceed" :on-change="handleChange" :show-file-list="false"
        :auto-upload="false">
        <template #trigger>
