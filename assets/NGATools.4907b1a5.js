import{_ as f,r as $,x as U,B as C,a as r,o as V,e as k,w as a,b as e,f as _,p as N,i as B,j as v,A as I,c as A}from"./index.b64a62c7.js";const E=d=>(N("data-v-407212e2"),d=d(),B(),d),T=E(()=>_("div",{class:"card-header"},[_("span",null,"\u6253\u725B\u8D34\u751F\u6210\u5668")],-1)),j={class:"footer"},z=v("\u751F\u6210"),G=v("\u91CD\u7F6E"),S={__name:"Cow",setup(d){const u=$(),l=U({title:"",team:"",weapon:"",summon:"",trial:"",ring1:"",ring2:"",ring3:"",comment:""}),{copy:b}=C();async function g(){const{title:c,team:o,weapon:n,summon:s,trial:m,ring1:p,ring2:i,ring3:t,comment:x}=l,w=`
[size=150%][b]${c}[/b][/size]   
[list]
[*]\u9635\u5BB9\uFF1A
${o}
