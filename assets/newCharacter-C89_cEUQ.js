import"./chunk-CilyBKbf.js";import{I as e,Q as t,R as n,_ as r,d as i,g as a,ht as o,i as s,lt as c,p as l,st as u,u as d,v as f,vt as p}from"./runtime-core.esm-bundler-8Br1IfNb.js";import"./css-DxNnJ1GY.js";import{n as m,t as h}from"./css-wtUbjjQY.js";import{t as g}from"./css-D43tjSss.js";import{b as _,x as v}from"./icon-D8rblXpj.js";import{n as y,t as b}from"./css-SsIxu3ba.js";import{t as x}from"./css-B8jpQFgD2.js";import{t as S}from"./css-B5t-OEht.js";import{t as C}from"./css-QqzDFjmx.js";import{t as w}from"./css-CMqAm8Eu.js";import{l as T,n as E}from"./index-ytFxdyNK.js";import{t as D}from"./_plugin-vue_export-helper-DjoU_TXQ.js";var O={class:`app-container`},k={class:`operation-button`},A={class:`operation-button`},j={class:`footer`},M=D(f({__name:`index`,setup(f){let D=c(),{formData:M,elementList:N,raceList:P,weaponList:F}=o(u({formData:{roleName:``,roleImage:``,element:``,race:``,weapon1:``,weapon2:``,voice:``,chargeAttackName:``,chargeAttackEffect:``,skillList:[{name:``,colddown:``,duration:``,effect:``}],supportSkillList:[{name:``,effect:``}]},elementList:[`火`,`水`,`土`,`风`,`光`,`暗`],raceList:[`星晶兽`,`人类`,`兽耳`,`豆丁`,`牛族`,`其他`],weaponList:[`剑`,`短`,`枪`,`斧`,`杖`,`铳`,`拳`,`弓`,`琴`,`刀`]})),{copy:I}=E();async function L(){let{roleName:e,roleImage:t,element:n,race:r,weapon1:i,weapon2:a,voice:o,chargeAttackName:s,chargeAttackEffect:c}=M.value,l=`
[quote][table]
[tr]
[td15][b]姓名[/b][/td]
[td20]
